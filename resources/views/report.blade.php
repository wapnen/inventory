...
footer {
  ...
  <body>
    <header class="clearfix">
      ...
      <h1>  STORE SDP - Sales Report </h1>

      <div id="project">

        <div><span>FROM </span> {{ date('F d, Y', strtotime($from)) }} <span>To</span>{{ date('F d, Y', strtotime($to)) }}</div>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="grand total">N{{number_format($total, 2)}}</td>
          </tr>
        </tbody>
      </table>
